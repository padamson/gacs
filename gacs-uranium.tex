...
\newcommand{\sekshun}[1]
           {
             \chapter{#1}
             \markboth{Genetic Algorithm Cluster Searching for Uranium-Containing Clusters}{#1}
           }
...
\makeindex
\title{Genetic Algorithm Cluster Searching for Uranium-Containing Clusters}
...
\markboth{Genetic Algorithm Cluster Searching for Uranium-Containing Clusters}{Genetic Algorithm Cluster Searching for Uranium-Containing Clusters}
%\pagenumbering{roman}
...
\cleardoublepage
\markboth{Genetic Algorithm Cluster Searching for Uranium-Containing Clusters}{Index}
\input{gacs-uranium.ind}
