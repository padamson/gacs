...
\newcommand{\sekshun}[1]
           {
             \chapter{#1}
             \markboth{Genetic Algorithm Cluster Searching}{#1}
           }
...
\makeindex
\title{Genetic Algorithm Cluster Searching}
...
\markboth{Genetic Algorithm Cluster Searching}{Genetic Algorithm Cluster Searching}
%\pagenumbering{roman}
...
\cleardoublepage
\markboth{Genetic Algorithm Cluster Searching}{Index}
\input{gacs.ind}
